...
// Directly embedding the service account credentials to eliminate any file loading or module resolution issues.
// The private key is wrapped in template literals (`) to correctly handle the newline characters.
