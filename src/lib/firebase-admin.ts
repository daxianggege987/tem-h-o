...
// The service account object, as provided.
const serviceAccount = {
  "type": "service_account",
  "project_id": "temporal-harmony-oracle",
  "private_key_id": "f1884b9893fd7f04e1fbd82872d5e85701e79f03",
  // The private key with escaped newlines, as it exists in the source file.
...
// **THE CRITICAL FIX**: The private key from the JSON file has "\\n" as literal strings.
// The Firebase Admin SDK needs actual newline characters to parse the key correctly.
...
if (!admin.apps.length) {
    try {
        ...
        console.log(`Firebase Admin SDK initialized successfully with formatted credentials.`);
    } catch (error: any) {
